...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['text_lumber'] = $this->language->get('text_lumber');

		/*Меню для сруба*/
		$data['about_company'] = $this->url->link('catalog/information/edit&information_id=7', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['operating_procedure'] = $this->url->link('catalog/information/edit&information_id=15', 'token=' . $this->session->data['token'], 'SSL');
		$data['important'] = $this->url->link('extension/important', 'token=' . $this->session->data['token'], 'SSL');
		$data['ads'] = $this->url->link('extension/ads', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['setting_main'] = $this->url->link('setting/setting', 'token=' . $this->session->data['token'], 'SSL');
		$data['gallery'] = $this->url->link('opencart_gallery/album', 'token=' . $this->session->data['token'], 'SSL');
		$data['product'] = $this->url->link('catalog/product', 'token=' . $this->session->data['token'], 'SSL');
		$data['prices'] = $this->url->link('extension/prices', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['head_office'] = $this->url->link('catalog/information/edit&information_id=17', 'token=' . $this->session->data['token'], 'SSL');
		$data['lumber'] = $this->url->link('extension/lumber', 'token=' . $this->session->data['token'], 'SSL');
		$data['category'] = $this->url->link('catalog/category', 'token=' . $this->session->data['token'], 'SSL');
		$data['category_prices'] = $this->url->link('extension/category_prices', 'token=' . $this->session->data['token'], 'SSL');
