...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
	  ...
	  $this->request->post['config_slogan_srub'] = $this->request->post['config_langdata'][$front_language_id]['slogan_srub'];
      ...
      $this->request->post['config_address'] = $this->request->post['config_langdata'][$front_language_id]['comment'];
		...
		$data['entry_slogan_srub'] = $this->language->get('entry_slogan_srub');
		...
		$data['help_contact_page'] = $this->language->get('help_contact_page');
		...
		$data['banner_head'] = $this->model_design_banner->getBanners();
		...
		if (isset($this->request->post['config_contact_page_inf'])) {
			$data['config_contact_page_inf'] = $this->request->post['config_contact_page_inf'];
		} else {
			$data['config_contact_page_inf'] = $this->config->get('config_contact_page_inf');
		}
		...
		if (isset($this->request->post['config_slogan_srub'])) {
			$data['config_slogan_srub'] = $this->request->post['config_slogan_srub'];
		} else {
			$data['config_slogan_srub'] = $this->config->get('config_slogan_srub');
		}
