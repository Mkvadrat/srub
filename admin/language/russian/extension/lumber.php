<?php
// Heading
$_['heading_title']          = 'Пиломатериалы';

// Text
$_['text_success']           = 'Успех: Вы изменили OpenCart Диспетчер изображений!';
...
$_['entry_gallery_name']     = 'Заголовок для галереи:';
$_['entry_title']            = 'Заголовок изображения';
...
$_['entry_category_text']    = 'Текст для категории:';

$_['help_keyword']           = 'Не используйте пробелы, и убедитесь,что ключевое слово является уникальным.';
