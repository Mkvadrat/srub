  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
		...
		<input type="hidden" name="minimum" value="<?php echo $minimum; ?>" />
		...
		<input type="hidden" name="length_class_id" value="<?php echo $length_class['length_class_id']; ?>" />
		<?php } ?>

		<?php foreach ($tax_classes as $tax_class) { ?>
		<input type="hidden" name="tax_class_id" value="<?php echo $tax_class['tax_class_id']; ?>" />
		<?php } ?>
		...
		<input type="hidden" name="weight_class_id" value="<?php echo $weight_class['weight_class_id']; ?>" />
		<?php } ?>

		<?php foreach ($product_attributes as $product_attribute) { ?>
		<input type="hidden" name="product_attribute[<?php echo $attribute_row; ?>][name]" value="<?php echo $product_attribute['name']; ?>" />
		<?php } ?>

		<?php foreach ($product_options as $product_option) { ?>
		<input type="hidden" name="option" value="" placeholder="<?php echo $entry_option; ?>" />
		<?php } ?>

		<?php foreach ($product_recurrings as $product_recurring) { ?>
		<input type="hidden" name="product_recurring[<?php echo $recurring_row; ?>][recurring_id]" value="<?php echo $recurring['recurring_id']; ?>" />
		<?php foreach ($customer_groups as $customer_group) { ?>
		<input type="hidden" name="product_recurring[<?php echo $recurring_row; ?>][customer_group_id]" value="<?php echo $customer_group['customer_group_id']; ?>" />
		<?php } ?>
		<?php } ?>

		<?php foreach ($product_discounts as $product_discount) { ?>
		<input type="hidden" name="product_discount[<?php echo $discount_row; ?>][customer_group_id]" value="<?php echo $customer_group['customer_group_id']; ?>" />
		<?php } ?>
...
function addImages(files, path, item) {
	...
	html += '  <td class="text-left"><a href="" id="thumb-image' + image_row + '"data-toggle="image" class="img-thumbnail"><img style="width:100px;height:100px;" src="' + files + '" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /><input type="hidden" name="product_image[' + image_row + '][image]" value="' + path + '" id="input-image' + image_row + '" /></td>';
