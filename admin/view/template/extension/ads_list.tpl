            ...
            <table class="table table-bordered table-striped table-hover">
			  ...
			  <tbody>
				<?php if ($all_ads) { ?>
				  ...
				  <tr>
					<td width="1" style="text-align: center;"><input type="checkbox" name="selected[]" value="<?php echo $ads['ads_id']; ?>" /></td>
					<td class="text-left"><a href="<?php echo $ads['edit']; ?>"><?php echo $ads['title']; ?></a></td>
					<td class="text-left"><?php echo $ads['short_description']; ?></td>
					<td class="text-left"><?php echo $ads['date_added']; ?></td>
					<td class="text-right"><a href="<?php echo $ads['edit']; ?>"><?php echo $text_edit; ?></a></td>
				  </tr>
				  <?php } ?>
				<?php } else { ?>
				  <tr>
