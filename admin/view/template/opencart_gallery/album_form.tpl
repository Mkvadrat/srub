...
function addImages(files, path, item) {
  ...
  html += '  <td class="text-left"><a href="" id="thumb-image' + image_row + '"data-toggle="image" class="img-thumbnail"><img style="width:100px;" src="' + files + '" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /><input type="hidden" name="album_image[' + image_row + '][image]" value="' + path + '" id="input-image' + image_row + '" /></td>';
