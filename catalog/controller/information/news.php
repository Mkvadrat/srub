...
class ControllerInformationNews extends Controller {
	public function index() {
		...
		foreach ($all_news as $news) {
			$data['all_news'][] = array (
				'title' 		=> $news['title'],
				'image'			=> $this->model_tool_image->resize($news['image'], '189', '140'),
				'description' => utf8_substr(strip_tags(html_entity_decode($news['description'], ENT_QUOTES, 'UTF-8')), 0, $this->config->get('config_product_description_length')) . '..',
