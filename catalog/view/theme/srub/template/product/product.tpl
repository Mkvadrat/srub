<?php echo $header; ?>
	...
	<div class="content-main-project-in"><?php echo $content_top; ?>
...
?>
		...
		<div class="about-contant">
				...
				<div class="inform-project">
					...
					<ul>
						<li><a href="<?php echo $gallery; ?>">Посмотреть галерею проекта</a></li>
						<li><a href="javascript:void(0)" class="back">Вернуться в предыдущее меню</a></li>
						<li><a href="<?php echo $category; ?>">Вернуться в категорию</a></li>
